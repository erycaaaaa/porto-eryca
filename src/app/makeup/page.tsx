...
export default function MakeupPortfolioPage() {
  return (
    <div
      className="
        relative w-full min-h-[5000px] 
        bg-[url('/porto-eryca/bg-mua.png')] bg-cover bg-center
      "
    >
        ...
        <section id="contact" className="mx-auto max-w-4xl px-6 py-16">
          <div className={`${PANEL} p-10 text-center`}>
            ...
            <p className={`mx-auto mt-3 max-w-xl ${MUTED}`}>
              Available for bridal, prewedding, graduation and events.
              On-location by request.
            </p>
