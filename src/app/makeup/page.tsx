    ...
    >
      ...
      <header className="sticky top-0 z-30 w-full">
        <nav className="mx-auto flex h-14 max-w-6xl items-center justify-between px-6 bg-white/0 backdrop-blur-[2px]">
          <a href="#makeup" className="leading-none">
            <span className={`${playfair.className} block text-3xl font-bold text-black`}>
              EDS
            </span>
            <span className={`${vibes.className} -mt-1 block text-xl text-neutral-600`}>
              model makeup
            </span>
          </a>
      ...
      >
        <div className="mx-auto max-w-6xl">
          ...
          <h1 className={`${playfair.className} mt-1 text-4xl font-bold md:text-6xl`}>
            ERYCA
          </h1>
      ...
      >
        <div className={`${PANEL} p-8 md:p-10`}>
          <p className="text-xs uppercase tracking-widest text-neutral-600">About Eryca</p>
          <h2 className={`${vibes.className} mt-2 text-3xl sm:text-4xl`}>Muse, based in Jakarta.</h2>
      ...
      <section className="mx-auto max-w-6xl px-6 pb-6">
        <ul className="flex flex-wrap items-center justify-center gap-12 opacity-80 grayscale hover:grayscale-0 transition">
          <li className="flex items-center justify-center text-4xl text-black/80"><FaGithub title="GitHub" /></li>
          <li className="flex items-center justify-center text-4xl text-sky-600"><SiReact title="React" /></li>
          <li className="flex items-center justify-center text-4xl text-pink-600"><SiFigma title="Figma" /></li>
        </ul>
      </section>
      ...
      <section id="portfolio" className="mx-auto max-w-6xl px-6 py-14">
        <div className={`${PANEL} flex items-end justify-between gap-4 p-6`}>
          <h2 className={`${vibes.className} text-3xl sm:text-4xl`}>Selected Works</h2>
        ...
        <ul className="mt-7 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <li key={i} className={`${CARD} relative aspect-square overflow-hidden`}>
              <Image
                src={g.src}
                alt={g.alt}
                width={800}
                ...
                priority={i < 2}
              />
              <span className={`${vibes.className} absolute bottom-3 left-3 rounded-full bg-white/90 px-3 py-1 text-sm font-medium text-neutral-800 shadow`}>
                {g.alt}
              </span>
            </li>
          ))}
      ...
      <section id="contact" className="mx-auto max-w-4xl px-6 py-16">
        <div className={`${PANEL} p-10 text-center`}>
          <h3 className={`${vibes.className} text-3xl sm:text-4xl`}>Ready to Collaborate?</h3>
