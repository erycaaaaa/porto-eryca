// src/components/tarot/HeroTarot.tsx
"use client";
...
export default function HeroTarot({
  ...
  cards = ["/porto-eryca/cards/the-fool.jpg", "/porto-eryca/cards/the-lovers.jpg", "/porto-eryca/cards/queen-of-swords.jpg"], // contoh fallback
}: {
  title?: string;
  subtitle?: string;
  cards?: string[];
  ...
  return (
    <header className="relative h-[90vh] flex flex-col justify-center items-center text-center text-white overflow-hidden">
