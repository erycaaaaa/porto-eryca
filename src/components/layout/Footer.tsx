...
export default function Footer({
  ...
  return (
    <footer
      id="footer"
      className="
        relative w-full border-t border-[#ffff] bg-[#1f1810] text-[#ffffff]
        shadow-[0_-4px_12px_rgba(0,0,0,0.4)]
        dark:bg-[#95927573] dark:text-white dark:border-[#1f1810]
      "
    >
          ...
          {groups.map((g) => (
            ...
            >
              <h3
                ...
                className="mb-2 text-sm font-semibold leading-none tracking-wide text-[#ffff]"
              >
                {g.heading}
              </h3>
                ...
                {g.items.map((it) => (
                  <li key={it.label}>
                    <a
                      ...
                      className="
                        rounded-[4px] px-0.5 text-[#ffff] transition-colors hover:text-[#ffff]
                        focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ffff]
            ...
            {Object.entries(socials).map(([k, url]) => {
              ...
              return (
                <a
                  ...
                  title={key}
                  className="
                    rounded-md bg-[#ffff] p-2 transition-colors hover:bg-[#d4cbb0]
                    focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ffff] group
                  "
                >
                  <span className="block transition-colors group-hover:text-[#1f1810]">
                    {icons[key]}
                  </span>
                </a>
              );
      ...
      {showBackToTop && (
        <a
          ...
          className="
            ...
            border border-[#ffff] bg-[#ffff] p-2
            shadow-[0_1px_0_rgba(255,255,255,0.06)_inset,0_8px_22px_rgba(0,0,0,0.25)]
            backdrop-blur-sm transition hover:bg-[#ffff] hover:text-[#ffff]
            focus:outline-none focus-visible:ring-2 focus-visible:ring-[#ffff]
        ...
        >
          <img
            ...
            className="h-[55px] w-[52px] select-none rounded-full ring-1 ring-[#ffff] shadow-[0_8px_22px_rgba(0,0,0,0.4)]"
            loading="lazy"
          />
          <span
            className="
              absolute -top-8 whitespace-nowrap rounded-md bg-black/80 px-2 py-1
              text-[11px] text-[#ffff] opacity-0 transition
